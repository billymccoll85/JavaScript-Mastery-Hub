const _products = [
  ...
  const productService = {
    ...
    // Function to simulate buying products with a chance of error
    buyProducts(products, successCallback, errorCallback) {
      setTimeout(() => {
        // Simulate random checkout success or failure
        const isSuccessful = Math.random() > 0.5 || navigator.userAgent.includes('PhantomJS');
        isSuccessful ? successCallback() : errorCallback();
      }, 100);
    }
  };
